...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> mha_fwd(
    ...
    const at::Tensor& k_cache,  // (b_k, s_k, h_k, d) or (total_k, h_k, d) if there is cu_seqlens_k or (num_pages,
                                // page_size, h_k, d) if there is page_table.
    const at::Tensor& v_cache,  // (b_k, s_k, h_k, dv) or (total_k, h_k, dv) if there is cu_seqlens_k or (num_pages,
