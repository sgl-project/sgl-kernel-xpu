...
This module dispatches directly to the native XPU op.
The public signature matches the native op and extends the previous wrapper
with `preshuffle_size` and `use_bf16_store`.
"""
