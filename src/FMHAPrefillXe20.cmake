...
option(FMHA_PREFILL_HD256_LARGE_TILE "Enable q256 paged head_dim=256 path for large AppendKV prefill" ON)
set(FMHA_PREFILL_HD256_LARGE_TILE_MIN_Q 256)
set(FMHA_PREFILL_HD256_LARGE_TILE_Q 256)
set(FMHA_PREFILL_HD256_LARGE_TILE_KV 64)
set(FMHA_PREFILL_HD256_LARGE_NUM_SG 32)
...
foreach(HEAD_DIM ${FMHA_PREFILL_PAGED_HEAD_DIMS})
    ...
    if(HEAD_DIM STREQUAL "256" AND FMHA_PREFILL_HD256_LARGE_TILE)
        set(HD256_PAGED_LARGE_TILE 1)
    else()
        set(HD256_PAGED_LARGE_TILE 0)
    endif()
    set(HD256_PAGED_LARGE_TILE_MIN_Q ${FMHA_PREFILL_HD256_LARGE_TILE_MIN_Q})
    set(HD256_PAGED_LARGE_TILE_Q ${FMHA_PREFILL_HD256_LARGE_TILE_Q})
    set(HD256_PAGED_LARGE_TILE_KV ${FMHA_PREFILL_HD256_LARGE_TILE_KV})
    set(HD256_PAGED_LARGE_NUM_SG ${FMHA_PREFILL_HD256_LARGE_NUM_SG})
