...
void Xe35MoEGEMMLauncher(
  ...
  auto event = q.submit([&](sycl::handler& h) {
    ...
    h.parallel_for<GemmXe35Name<Tile, SGLayout, TensorA, TensorB, TensorD, Element, ActType, FuseAct, WithBias>>(
...
#define LAUNCH_MOE(...)                       \
  Xe35MoEGEMMLauncher<__VA_ARGS__>(           \
      queue,                                  \
