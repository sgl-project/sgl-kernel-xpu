...
#define IS_COMPLEX_FLOAT(scalar_t) (std::is_same<scalar_t, c10::complex<float>>::value)

#define IS_COMPLEX_DOUBLE(scalar_t) (std::is_same<scalar_t, c10::complex<double>>::value)

#define IS_FLOAT(scalar_t) (IS_DOUBLE(scalar_t) || IS_FLOAT32(scalar_t) || IS_BFLOAT16(scalar_t) || IS_HALF(scalar_t))

#define IS_INTEGRAL(scalar_t) \
  (IS_UINT8(scalar_t) || IS_INT8(scalar_t) || IS_INT(scalar_t) || IS_INT64(scalar_t) || IS_INT16(scalar_t))

#define IS_COMPLEX(scalar_t) (IS_COMPLEX_FLOAT(scalar_t) || IS_COMPLEX_DOUBLE(scalar_t))
