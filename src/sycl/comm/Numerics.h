...
struct Numerics<c10::complex<float>> {
  static inline c10::complex<float> acos(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::acos(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> sin(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::sin(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> cosh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::cosh(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> acosh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::acosh(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> sinh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::sinh(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> asinh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::asinh(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> asin(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::asin(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> cos(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::cos(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> atan(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::atan(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> tan(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::tan(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> tanh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::tanh(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> atanh(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::atanh(static_cast<std::complex<float>>(a)));
  }
  ...
  static inline c10::complex<float> sqrt(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::sqrt(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> rsqrt(c10::complex<float> a) {
    return c10::complex<float>(1.0, 0) /
           static_cast<c10::complex<float>>(std::sqrt(static_cast<std::complex<float>>(a)));
  }
  ...
  static inline c10::complex<float> exp(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::exp(static_cast<std::complex<float>>(a)));
  }

  static inline c10::complex<float> add(c10::complex<float> a, c10::complex<float> b) {
    return a + b;
  }
  static inline c10::complex<float> mul(c10::complex<float> a, c10::complex<float> b) {
    return a * b;
  }
  static inline c10::complex<float> sub(c10::complex<float> a, c10::complex<float> b) {
    return a - b;
  }
  static inline c10::complex<float> div(c10::complex<float> a, c10::complex<float> b) {
    return a / b;
  }

  static inline c10::complex<float> pow(c10::complex<float> a, c10::complex<float> b) {
    return static_cast<c10::complex<float>>(
        std::pow(static_cast<std::complex<float>>(a), static_cast<std::complex<float>>(b)));
  }

  static inline c10::complex<float> log(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::log(static_cast<std::complex<float>>(a)));
  }
  ...
  static inline c10::complex<float> log10(c10::complex<float> a) {
    return static_cast<c10::complex<float>>(std::log10(static_cast<std::complex<float>>(a)));
  }
...
struct Numerics<c10::complex<double>> {
  static inline c10::complex<double> acos(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::acos(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> sin(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::sin(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> cosh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::cosh(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> acosh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::acosh(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> sinh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::sinh(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> asinh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::asinh(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> asin(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::asin(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> cos(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::cos(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> atan(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::atan(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> tan(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::tan(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> tanh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::tanh(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> atanh(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::atanh(static_cast<std::complex<double>>(a)));
  }
  ...
  static inline c10::complex<double> sqrt(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::sqrt(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> rsqrt(c10::complex<double> a) {
    return c10::complex<double>(1.0, 0) /
           static_cast<c10::complex<double>>(std::sqrt(static_cast<std::complex<double>>(a)));
  }
  ...
  static inline c10::complex<double> exp(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::exp(static_cast<std::complex<double>>(a)));
  }

  static inline c10::complex<double> add(c10::complex<double> a, c10::complex<double> b) {
    return a + b;
  }
  static inline c10::complex<double> mul(c10::complex<double> a, c10::complex<double> b) {
    return a * b;
  }
  static inline c10::complex<double> sub(c10::complex<double> a, c10::complex<double> b) {
    return a - b;
  }
  static inline c10::complex<double> div(c10::complex<double> a, c10::complex<double> b) {
    return a / b;
  }

  static inline c10::complex<double> pow(c10::complex<double> a, c10::complex<double> b) {
    return static_cast<c10::complex<double>>(
        std::pow(static_cast<std::complex<double>>(a), static_cast<std::complex<double>>(b)));
  }

  static inline c10::complex<double> log(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::log(static_cast<std::complex<double>>(a)));
  }
  ...
  static inline c10::complex<double> log10(c10::complex<double> a) {
    return static_cast<c10::complex<double>>(std::log10(static_cast<std::complex<double>>(a)));
  }
