...
// NOTE: Xe3 (xe35/CRI)-dedicated copy of the corresponding xe20 (BMG) header.
// Kept separate (not shared with kernels/moe/xe20/) so Xe3 porting does not
// perturb the existing Xe2 bf16/mxfp4_w4a16 grouped-GEMM kernels.
