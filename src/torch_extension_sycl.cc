...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      ...
      "Tensor loc, Tensor(a!) k_buf, Tensor(a!) v_buf, int q_off, int k_off, int v_off, "
      "int dq, int dkv, bool silu_activation, bool use_residual, bool do_store, Tensor log_scaling_tau) "
  ...
  m.def(
      ...
      "bool use_residual, bool do_store, bool do_cache_update, Tensor log_scaling_tau) -> (Tensor, Tensor, Tensor)");
